      ...
      <div className="bg-white dark:bg-slate-900 rounded-2xl shadow-sm border border-gray-100 dark:border-slate-800 overflow-hidden">
        ...
        <div className="p-6">
          ...
          {activeDomain.domainStatus !== 'LIVE' && activeDomain.dnsInstructions && (
            <div className="border border-purple-200 bg-purple-50/50 dark:bg-blue-900/10 dark:border-blue-900 rounded-xl p-6 mb-6">
              <h4 className="text-base font-bold text-purple-900 dark:text-blue-100 mb-4 flex items-center gap-2">
                <AlertCircle className="w-5 h-5 text-purple-600" /> Setup Instructions
              </h4>
              <p className="text-sm text-purple-800 dark:text-blue-200 whitespace-pre-wrap">
